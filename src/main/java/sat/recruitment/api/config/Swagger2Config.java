package sat.recruitment.api.config;
...
public class Swagger2Config {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.apis(RequestHandlerSelectors.basePackage("sat.recruitment.api"))
				.paths(PathSelectors.any()).build();
	}

	@SuppressWarnings({"deprecation"})
	private ApiInfo getApiInfo() {
		return new ApiInfoBuilder().title("Recruitment api")
				.description("API para recruitment")
